...
class Rope:
    ...
    def pack_backward(
        ...
        """packed dqkvdq/dkrope backward,dqkv."""
...
class MRope:
    ...
    def pack_backward(self, dqkv, q_num_heads, kv_num_heads, cos, sin, mrope_section):
        """packed dqkvdq/dkmrope backward,dqkv."""
        self.pack_bwd_kernel(
            dqkv,
            cos,
            sin,
