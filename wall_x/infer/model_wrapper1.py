...
class WallxModelWrapper:
    ...
    def _register_normalizers(self):
        ...
        pt="/x2robot_v2/share/yangping/ckpt/robochallenge_github/benchmark/libero/bus2507_plus_moe-0125/8/normalizer_action.pth"
        self.normalizer_action = Normalizer.from_ckpt(pt)

        self.normalizer_propri = Normalizer.from_ckpt("/x2robot_v2/share/yangping/ckpt/robochallenge_github/benchmark/libero/bus2507_plus_moe-0125/8/normalizer_propri.pth")
    ...
    def construct_model_input(self, observation, prefix_text, postfix_text):
        ...
        dataset_names = ["libero"] * batch_size
