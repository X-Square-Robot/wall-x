...
class WallxModelWrapper:
    ...
    def _register_normalizers(self):
        ...
        self.normalizer_action = Normalizer.from_ckpt("/x2robot_v2/share/yangping/ckpt/robochallenge_github/benchmark/libero/bus2507_plus_moe-0126/7/normalizer_action.pth")
        self.normalizer_propri = Normalizer.from_ckpt("/x2robot_v2/share/yangping/ckpt/robochallenge_github/benchmark/libero/bus2507_plus_moe-0126/7/normalizer_propri.pth")
    ...
    def infer_flow_action(self, observation, instruction):
        ...
        padding = (
            torch.zeros_like(
                self.normalizer_action.delta[model_input["dataset_names"][0].replace("_all", "")]
            )
            .unsqueeze(0)
            .to("cpu")
        )
